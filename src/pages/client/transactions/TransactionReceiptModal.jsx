...
import { 
    ...
    ReceiptText, CheckCircle2, Clock3, RotateCcw, Loader2 
} from "lucide-react";
...
// Mirrors your existing configuration
const TYPE_CONFIG = {
...
const STATUS_CONFIG = {
    ...
    approved:  { label: "Approved",  className: "bg-success/10 text-success", icon: CheckCircle2 }, // For reference table statuses
...
const TransactionReceiptModal = ({ transaction, onClose }) => {
    ...
    useEffect(() => {
        ...
        const fetchDeepDetails = async () => {
            // Only fetch if there is a reference table (deposits or withdrawals)
        ...
        <Modal isOpen={!!transaction} onClose={onClose} title="Transaction Details">
            ...
            <div className="p-6">
                <div className="bg-surface-alt rounded-xl border border-border p-1 px-4">
                    ...
                    {/* Additional Details fetched from referenced tables */}
                    {loading && (
                    ...
                    {!loading && details && transaction.reference_table === "withdrawals" && (
                        <>
                            ...
                            {/* Assuming payment_details is a JSON object with an address or account field */}
                            <DetailRow 
                                label="Destination" 
